...
public class CustomWidget extends JPanel implements MouseListener {
    ...
    private final Color SelectedHexColor = Color.green;
    private final Color DefaultHexColor = Color.white;

    private final Color SelectedOctagonColor = Color.red;
    private final Color DefaultOctagonColor = Color.white;
    ...
    private void getPolygonVertices(
    ...
    public void paintComponent(Graphics g) {
        ...
        if (hexagonSelected) {
            g2d.setColor(SelectedHexColor);
        } else {
            g2d.setColor(DefaultHexColor);
        }
        g2d.fill(shape);
        ...
        if (octagonSelected) {
            g2d.setColor(SelectedOctagonColor);
        } else {
            g2d.setColor(DefaultOctagonColor);
        }
        g2d.fill(shape);
    }
